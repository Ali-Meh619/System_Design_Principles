...
window.TOPICS = [
...

  {
    ...
    subtopics:  [
      ...
      "Chain-of-Thought — Why it works (compute, error localisation, conditioning); when it fails (hallucinated CoT, faithfulness gap, cascade errors)",
      "RLHF — SFT → reward model → PPO; why it's complex and unstable",
      "DPO — Direct preference optimization; no RL, no reward model; simpler",
      "LLM Evaluation — MMLU, HumanEval, GSM8K, MT-Bench, LLM-as-judge",
    ...
    tags:  ["llm", "genai", "transformers", "rag", "lora", "qlora", "fine-tuning", "prompt engineering", "rlhf", "dpo", "kv cache", "quantization", "hallucination", "attention", "interview"],
