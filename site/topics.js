...
window.TOPICS = [
...

  {
    ...
    icon:       "📋",
    difficulty: "beginner",
    summary:    "12 full system design blueprints: YouTube, Twitter feed, WhatsApp, Uber, TinyURL, Rate Limiter, Metrics, TicketMaster, AI Agent, Typeahead, Google Docs, LeetCode.",
    subtopics:  [
      "Read-Heavy Content (YouTube, Netflix, Dropbox)",
      "Social Feed / Write-Heavy (Twitter, Instagram)",
      "Real-time Chat (WhatsApp, Slack)",
      "Location-Based Service (Uber, Yelp)",
      "URL Shortener / ID Generation (TinyURL)",
      "Rate Limiter System",
      "Realtime Monitoring / Metrics System",
      "Booking / Ticketing (TicketMaster, Airbnb)",
      "Autonomous Coding Agent (Devin, Cursor)",
